...
PRODUCTION_APP_INSTANCE = "yotta-events-production"
STAGING_APP_INSTANCE = ""
DEVELOPMENT_APP_INSTANCE = ""

LOCAL_MEDIA_DIR = "media"
LOCAL_IMAGES_DIR = LOCAL_MEDIA_DIR + "/original_images"
LOCAL_DATABASE_NAME = PROJECT_NAME = "yotta"
LOCAL_DATABASE_USERNAME = "yotta"
...
def import_data(c, database_filename):
    ...
    # Create Heroku specific schemas
    psql(c, "CREATE SCHEMA _heroku;")
...
def pull_database_from_heroku(c, app_instance, anonymise=False):
    ...
    import_data(c, f"/{LOCAL_DUMP_DIR}/{datestamp}.dump")
